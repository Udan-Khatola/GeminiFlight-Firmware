...
float Kd_roll_angle = 0.05;   //Roll D-gain - angle mode (has no effect on controlANGLE2) (default=0.05)
...
float Kd_pitch_angle = 0.05;  //Pitch D-gain - angle mode (has no effect on controlANGLE2) (default=0.05)
